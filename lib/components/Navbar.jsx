        ...
        <nav className="w-full px-4 py-4 flex justify-between items-center bg-black">
            ...
            <div className="hidden md:flex space-x-6">
                <Link href="/products" className="flex relative group">
                    <span className="text-white px-2 text-sm font-mono cursor-pointer">PRODUCTOS</span>
                </Link>
                <Link href="/products" className="flex relative group">
                    <span className="text-white px-2 text-sm font-mono cursor-pointer">NOSOTROS</span>
                </Link>
                <Link href="/products" className="flex relative group">
                    <span className="text-white px-2 text-sm font-mono cursor-pointer">CONTACTANOS</span>
                </Link>
            </div>
            <div className="hidden md:flex space-x-6">
                ...
                {isMenuOpen && (
                    <div
                        ...
                        <Link href="/products" className="relative group">
                            <span className="text-white text-xl font-mono cursor-pointer">Productos</span>
                        </Link>
                        <Link href="/products" className="relative group">
                            <span className="text-white text-xl font-mono cursor-pointer">Nosotros</span>
                        </Link>
                        <Link href="/products" className="relative group">
                            <span className="text-white text-xl font-mono cursor-pointer">Contactanos</span>
                        </Link>
                        <Link href="/cart" className="relative group">
                            <ShoppingCartIcon
                                className="w-7 h-7 text-white transition-transform group-hover:scale-110 duration-300"/>
